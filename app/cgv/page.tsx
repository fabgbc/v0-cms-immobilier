      ...
      <main className="pt-16 min-h-screen">
        <section className="py-16 sm:py-24 lg:py-28 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto prose prose-neutral">
            <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-medium tracking-tight mb-8 sm:mb-12">Conditions Générales de Vente</h1>

            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed mb-6 sm:mb-8">
              Dernière mise à jour : février 2026
            </p>

            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Article 1 — Objet</h2>
            ...
            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Article 2 — Services</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
            ...
            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Article 3 — Abonnement et tarification</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
            ...
            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Article 4 — Paiement</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
            ...
            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Article 5 — Résiliation</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
            ...
            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Article 6 — Propriété intellectuelle</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
            ...
            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Article 7 — Responsabilité</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
            ...
            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Article 8 — Droit applicable</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
