      ...
      <main className="pt-16 min-h-screen">
        <section className="py-16 sm:py-24 lg:py-28 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto prose prose-neutral">
            <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-medium tracking-tight mb-8 sm:mb-12">Politique de confidentialité</h1>

            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed mb-6 sm:mb-8">
              Dernière mise à jour : février 2026
            </p>

            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Collecte des données</h2>
            ...
            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Utilisation des données</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
            ...
            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Conservation des données</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
            ...
            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Vos droits</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
            ...
            <ul className="text-base sm:text-lg text-muted-foreground leading-relaxed space-y-2 mt-4 list-disc pl-6">
            ...
            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Cookies</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
            ...
            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Contact</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
