      ...
      <main className="pt-16 min-h-screen">
        <section className="py-16 sm:py-24 lg:py-28 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto prose prose-neutral">
            <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-medium tracking-tight mb-8 sm:mb-12">Mentions légales</h1>

            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Éditeur du site</h2>
            ...
            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Hébergement</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
              Le site est hébergé par Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, États-Unis.
            </p>

            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Propriété intellectuelle</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
            ...
            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Responsabilité</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
            ...
            <h2 className="font-serif text-lg sm:text-xl font-medium mt-8 sm:mt-10 mb-3 sm:mb-4">Crédits</h2>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
